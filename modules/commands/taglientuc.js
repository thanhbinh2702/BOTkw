...
setTimeout(() =>
api.sendMessage({
   body:"Tới công chuyện rồi chuẩn bị chưa bạn trẻ" + mentions[mention].replace("@", "") ,
   mentions: [{
...
setTimeout(() =>
api.sendMessage("Đợi lấy hơi cái đã :3", threadID), 2000)
...
setTimeout(() =>
api.sendMessage({
   body: "Lên lẹ còn kịp bạn ơi "+ mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body: "Nhanh nhanh nào chậm chạp vậy "+ mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body: "Cháy nhà rồi kìa alo alo "+ mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body:"Về đi mọi người đang trông chờ " + mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body: "Ông trời tạo ra địa chấn "+ mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body: "Về nhanh còn kịp này "+ mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body: "Có về ko thì bảo "+ mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
...
setTimeout(() =>
api.sendMessage({
   body: "Còn bạn là điểm nhấn nên về đi bạn ơi "+ mentions[mention].replace("@", "") ,
   mentions: [{
    tag: mentions[mention].replace("@", ""),
    id: mention
   }]
