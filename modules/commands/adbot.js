...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`梁Admin Bot梁\n
👀 Tên: Châu Thanh Bình ( Kiwi )
❎ Tuổi: 25 🐁
👤 Giới tính: Nam
💫 Chiều cao cân nặng: 1m68 x 90kg
💘 Mối quan hệ: Đã có Ny
🌎 Quê quán: Đắk Lắk
🌸 Tính cách: Vui buồn thất thường,
🌀 Sở thích: Chơi game, đọc truyện, ăn, ngủ
💻Contact💻
☎ SĐT&Zalo:0375657254
🌐 Facebook: https://www.facebook.com/thanhbinh2702
✉️ Email: kiwiyeubo@gmail.com`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100061086373116}/picture?height=720&width=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(
...
if (args[0] == "user") { 
    ...
    var gender = sex == 2 ? "Nam" : sex == 1 ? "Nữ" : "Buê Đuê";
